...
|-----|----------|----------|------|------|---------|----------|----------|
| 1 | 00:00:00 | 00:00:08 | 8.4 | 3 | 1 | 0.0000 | 0.0000 |
| 3 | 00:00:09 | 00:00:26 | 16.8 | 6 | 3 | 0.0611 | 0.1111 |
| 5 | 00:00:28 | 00:00:38 | 10.27 | 3 | 2 | 0.0593 | 0.1429 |
| 7 | 00:00:40 | 00:00:50 | 10.27 | 3 | 2 | 0.0000 | 0.0000 |
...
| 2 | 00:00:04 | 00:00:17 | 13.07 | 4 | 3 | 0.1151 | 0.2333 |
| 4 | 00:00:19 | 00:00:34 | 14.93 | 5 | 3 | 0.0887 | 0.1939 |
| 6 | 00:00:36 | 00:00:50 | 14.0 | 5 | 3 | 0.2486 | 0.4872 |
| 8 | 00:00:51 | 00:01:04 | 13.07 | 4 | 3 | 0.0208 | 0.1429 |
| 10 | 00:01:06 | 00:01:22 | 15.87 | 5 | 4 | 0.0573 | 0.1708 |
| 13 | 00:01:24 | 00:01:36 | 12.13 | 4 | 3 | 0.0199 | 0.0741 |
| 15 | 00:01:38 | 00:01:47 | 9.33 | 3 | 3 | 0.0831 | 0.2063 |
| **Average** | | | | | | **0.1046** | **0.2261** |

**Sample 3** — CNN News18, 1 min

| SEG | START | END | DUR | JUMP | STORIES | FRAG CER | FRAG WER |
|-----|----------|----------|------|------|---------|----------|----------|
| 1 | 00:00:00 | 00:00:27 | 27.0 | 8 | 4 | 0.0212 | 0.1283 |
| 2 | 00:00:27 | 00:00:31 | 4.0 | 1 | 1 | 0.0000 | 0.0000 |
| **Average** | | | | | | **0.0106** | **0.0642** |

**Sample 5** — DD India, 10 mins

*Contains 46 segments in total; only the first 7 are shown below for brevity. The average row reflects the full segment set.*

| SEG | START | END | DUR | JUMP | STORIES | FRAG CER | FRAG WER |
|-----|----------|----------|-------|------|---------|----------|----------|
| 1 | 00:00:00 | 00:00:05 | 5.6 | 2 | 1 | 0.0000 | 0.0000 |
| 3 | 00:00:06 | 00:00:22 | 15.87 | 5 | 2 | 0.1988 | 0.4423 |
| 5 | 00:00:23 | 00:00:36 | 13.07 | 4 | 3 | 0.1053 | 0.2083 |
| 7 | 00:00:38 | 00:00:50 | 12.13 | 4 | 2 | 0.0846 | 0.1666 |
| 9 | 00:00:52 | 00:00:59 | 7.47 | 2 | 1 | 0.1395 | 0.1667 |
| 11 | 00:01:00 | 00:01:13 | 13.07 | 4 | 3 | 0.0898 | 0.3429 |
| 13 | 00:01:14 | 00:01:24 | 9.33 | 3 | 3 | 0.0208 | 0.1111 |
| **Average (all 46 segments)** | | | | | | **0.1307** | **0.2743** |
...
| 2 | 00:07:54 | 00:07:59 | 5.6 | 2 | 2 | 0.0000 | 0.0000 |
| 3 | 00:07:59 | 00:08:08 | 8.4 | 3 | 1 | 0.0909 | 0.3077 |
| 4 | 00:08:08 | 00:08:22 | 14.0 | 5 | 1 | 0.0123 | 0.0909 |
| 7 | 00:08:24 | 00:08:45 | 21.47 | 8 | 2 | 0.0411 | 0.1337 |
| 8 | 00:08:45 | 00:09:46 | 60.67 | 22 | 6 | 0.0439 | 0.2175 |
| 12 | 00:09:50 | 00:09:55 | 4.67 | 1 | 1 | 0.8148 | 1.0000 |
| **Average** | | | | | | **0.1683** | **0.2971** |

*Note: Sample 6's first segment spans nearly 8 minutes (474s) — the scene-change detector found essentially one long stable shot at the start of this clip, making segment mode behave close to full-length mode for that portion.*
...
| Sample 2 | DD India | 2 mins | 0.0571 | 0.1046 | 0.2187 | 0.2261 |
| Sample 3 | CNN News18 | 1 min | 0.0328 | 0.0106 | 0.0976 | 0.0642 |
| Sample 4 | CNN News18 | 2 mins | 0.0379 | n/a — no segments | 0.0900 | n/a — no segments |
| Sample 5 | DD India | 10 mins | 0.1536 | 0.1307 | 0.3234 | 0.2743 |
| Sample 6 | CNN News18 | 10 mins | 0.2834 | 0.1683 | 0.3705 | 0.2971 |
| **Average*** | | | **0.1142** | **0.0889** | **0.2159** | **0.1850** |

*\*Average across the five samples where segment mode produced results (excludes Sample 4).*

**Why segment mode tends to score lower error:** segment mode shows a lower average CER/WER than full-length mode on four of five comparable samples — most visibly on the two 10-minute clips, where full-length mode's error compounds over a much longer continuous read. This is consistent with segment mode's precision-based evaluation: shorter, scene-bounded fragments give the OCR/story-assembly pipeline less room to drift or misalign story boundaries than one long continuous read does.

Sample 2 is the exception — segment mode's average CER is nearly double full-length mode's (0.1046 vs. 0.0571). Its segments were also comparatively short and numerous (8 segments across 2 minutes, durations from 4.67s to 15.87s), close to the pipeline's own 3-second minimum-duration filter, which may partly explain the reduced reliability there relative to the other samples.
...
```
Video Input (upload or direct link)
        │
        ▼
Manual Ticker Region Selection (percentage coordinates, live preview)
        │
        ▼
   ┌─────────────┴─────────────┐
   ▼                           ▼
Full Length Mode          Segment Mode
(start timestamp,         (scene-change split via
 read to end)              Bhattacharyya distance,
   │                        each segment read
   │                        independently)
   ▼                           ▼
Sliding-Window OCR (Tesseract) over ticker crop
        │
        ▼
Story Stitching (merge overlapping reads, detect story boundaries)
        │
        ▼
Optional Evaluation (CER/WER against uploaded ground-truth script)
        │
        ▼
Results: story/segment list with timestamps, synced to video playback
```
