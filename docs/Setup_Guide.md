...
Reference coordinates for known channels are kept in [`docs/sample_coordinates.txt`]. To generate a synthetic test clip instead of using a real broadcast video:
